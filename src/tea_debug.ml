...
type state = Running | Paused of int
           ...
           li
             ...
             [
               span
                 ...
                 [
                   (if selected && model.show_details then view_details cmodel
                    else noNode);
                 ];
          ...
          [
            ...
            nav []
              [
                ...
                (if paused then view_history model selected_index else noNode);
              ];
          ];
      ]
  in
...
let beginnerProgram :
 ...
 fun { model; update; view } string_of_msg opnode flags ->
  let debugged =
...
let program :
    ...
    'flags ->
    'msg debug_msg Tea_app.programInterface =
 fun { init; update; view; subscriptions; shutdown } string_of_msg opnode flags ->
  let debugged =
